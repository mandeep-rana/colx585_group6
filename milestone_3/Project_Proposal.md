...
**Portugese text to English text through OpenNMT :** We trained OpenNMT for a Portugese text to English text translation model. The training used pre-trained Fasttext embeddings for Portugese and English, with a dimention of 300. The training is run on Google Colab, and the BLEU score on the development dataset is initially 4.98. Later we used Spacy to tokenize the Portuguese text and English text training data, which improved the BLEU score to 9.05. 
